...
class KifuForm(FlaskForm):
    kifu = TextAreaField('Paste kifu here (<a href="https://pastebin.com/rMbuqTSz">Sample</a>)', validators=[DataRequired()])
    delay = FloatField('Time delay between moves, in seconds. Might not work below 0.1 seconds', default=1.0)
    start_delay = FloatField('Time for the start position, in seconds.', default=1.0)
